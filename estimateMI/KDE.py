...
class KDE(object):
    ...
    def __init__(self, kernel='gaussian', n_jobs=-1, seed=None, **kwargs):
        """
            ...
            Args:
                - kernel: Distribution of the kernel
    ...
    def train(self, dataset, device, batch_size=128): #n_jobs_dataloader,
        """
            ...
            Args:
                - dataset (num_datapoints, num_features): Training dataset
                - device: Torch device
        ...
        if self.bandwidth is None:
            print("Searching over bandwidths...", end="")
    ...
    def log_likelihood(self, samples, device):
        """
            ...
            Args:
                - samples (num_samples, num_features): Samples
                - device: Torch device
